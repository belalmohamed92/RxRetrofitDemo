...
import com.example.modeso_mmac.rxjavaexample.adapters.UsersListAdapter;
 ...
 * www.modeso.ch
 */
public class MainActivity extends AppCompatActivity implements ListChangeListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (searchEditText != null) {
            mViewModel = new MainActivityViewModel(RxTextView.textChanges(searchEditText), this);
